...
namespace KurisuSivir
{
    internal class KurisuSivir
    {
        ...
        public KurisuSivir()
        {
            ...
            Utility.DelayAction.Add(1100, () =>
            {
                if (Menu.GetMenu("ezEvade", "ezEvade").IsRootMenu)
                {
                    Config.Item("eint").SetValue(true);
                    Game.PrintChat("<font color=\"#66FF33\"><b>KurisuSivir</b></font>: ezEvade Integration Enabled!");
                ...
                {
                    Config.Item("eint").SetValue(true);
                    Game.PrintChat("<font color=\"#66FF33\"><b>KurisuSivir</b></font>: Evade# Integration Enabled!");
                }

                if (Menu.GetMenu("Activator", "activator").IsRootMenu)
                    Game.PrintChat("<font color=\"#66FF33\"><b>KurisuSivir</b></font>: For the best experiance use the built in auto shield only!");

                if (Menu.GetMenu("Evade", "Evade") == null && Menu.GetMenu("ezEvade", "ezEvade").IsRootMenu)
                {
                    Config.Item("eint").SetValue(false);
                    Game.PrintChat("<font color=\"#66FF33\"><b>KurisuSivir</b></font>: Evade not found, Evade is reccomended!");
                }

            });

            Game.PrintChat("<font color=\"#66FF33\"><b>KurisuSivir</b></font>: Loaded!");
        }
