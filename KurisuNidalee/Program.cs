...
namespace KurisuNidalee
{
    ...
    internal class Program
    {
        ...
        private static void NidaMenu()
        {
            ...
            var nidaSpells = new Menu(":: Combo", "spells");
            ...
            var nidaHeals = new Menu(":: Heal Settings", "hengine");
            ...
            var nidaHarass = new Menu(":: Harass", "harass");
            ...
            var nidaJungle = new Menu(":: Jungle", "jungleclear");
            ...
            var nidalhit = new Menu(":: Freeze", "lasthit");
            ...
            var nidalc = new Menu(":: Waveclear", "laneclear");
            ...
            var nidaD = new Menu(":: Drawings", "drawings");
            ...
            SPrediction.Prediction.Initialize(_mainMenu);
        ...
        private static void UseCombo(Obj_AI_Base target)
        {
            ...
            if (_cougarForm && target.IsValidTarget(Javelin.Range))
            {
                ...
                if (HQ == 0 && _mainMenu.Item("usecougarr").GetValue<bool>())
                {
                    ...
                    var prediction = Javelin.GetSPrediction((Obj_AI_Hero) target);
            ...
            if (!_cougarForm && target.IsValidTarget(Javelin.Range))
            {
                ...
                {
                    Javelin.SPredictionCast(qtarget,
            ...
            if (!_cougarForm && target.IsValidTarget(Javelin.Range))
            {
                ...
                if (Bushwack.IsReady() && _mainMenu.Item("usehumanw").GetValue<bool>())
                {
                    ...
                    {
                        Bushwack.SPredictionCast((Obj_AI_Hero) target, HitChance.Medium);
                    }
                }
            }
        }
